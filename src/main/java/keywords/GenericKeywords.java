...
public class GenericKeywords {
	...
	public WebElement getElement(String locatorKey) {
		...
		try {
			...
			System.out.println("It came in catch statement ");
			return null;
		}
	...
	/*
	 * public WebElement getElement(String locatorKey) { try { // Wait until the
	 * element is present and visible WebDriverWait wait = new WebDriverWait(driver,
	 * 10); WebElement e =
	 * wait.until(ExpectedConditions.visibilityOfElementLocated(getLocator(
	 * locatorKey))); return e; } catch (NoSuchElementException nse) {
	 * System.out.println("Element not present: " + locatorKey); } catch
	 * (TimeoutException te) { System.out.println("Element not visible after wait: "
	 * + locatorKey); } catch (Exception ex) {
	 * System.out.println("Exception while retrieving the element: " +
	 ...
	 * (JavascriptExecutor)driver; int i=0; // ajax status while(i!=10){ String
